        ...
        <div>
            ...
            <div className="row leadListData mb-5">
                <div className="col-xl-4 col-lg-4 col-12 agentViewBtns">
                    ...
                    <div className="btn btn mt-3 py-2" style={{background: "#2E2E2E", color: "#fff"}} onClick={() => navigate("/agentList")}>Show Leads By Agent</div>
                </div>
                <div className="col-xl-6 col-lg-6 col-11">
                    <h3 className="my-3">Lead List By Status</h3>
                    {filterData.length != 0
                    ?
                    <div>
